...
Completed 2026-05-14. Implemented file-backed projects/tasks, safe task status writes, one-task heartbeat dispatch through Pi, raw HTML project/task/kanban UI with progressive drag-and-drop, run project/task metadata, docs, and validation.
